...
| `knowledge/principle/review-checklist.md` | Core review checklist | Yes (if exists; generated by `#init`) |
| `knowledge/principle/coding-standards.md` | Coding standards for review criteria | Yes (if exists; generated by `#init`) |
