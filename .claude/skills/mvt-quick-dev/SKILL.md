...
### Boundaries
- Do NOT analyze complex requirements (use `/mvt-analyze` instead) (routes there by default; the user may explicitly waive routing for structural work, in which case the waiver rules (WS-1, QD-2, QD-5) apply)
- Do NOT design architecture (use `/mvt-design` instead) (routes there by default; the user may explicitly waive routing for structural work, in which case the waiver rules (WS-1, QD-2, QD-5) apply)
- Do NOT review code (use `/mvt-review` instead) (routes there by default; the user may explicitly waive routing for structural work, in which case the waiver rules (WS-1, QD-2, QD-5) apply)
